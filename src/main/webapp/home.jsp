...
<html>
    <head>
        ...
        <jsp:forward page="/general-error.html"/>
        <% } %>
<style>
    .hovereffect {
        width: auto;
    ...
    <script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v9.0&appId=691110148472794&autoLogAppEvents=1" nonce="O67w0iEg"></script>
    ...
    <div id="fb-root"></div>
    <script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v8.0&appId=691110148472794&autoLogAppEvents=1" nonce="iGO5Dyev"></script>
    <script>
    ...
    <button type="button" class="btn btn-light btn-lg" style="position: absolute; right: 5px;" onclick="signOut()">Sign Out</button>
    <div class="padding">
        <div class="well">
        <div class="card" >
            <div class="card-title">
                <h3>Generate HashTag</h3>
            </div>
